  ...
  return (
    ...
    >
        ...
        <div className="w-[475px] h-[553px] border border-solid border-[rgba(242,91,56,0.7)] rounded-2xl border-1 border-opacity-50 backdrop-filter backdrop-blur-md p-4 flex flex-col justify-between bg-[rgba(43,43,103,0.5)]">
          <div className="flex items-center justify-center mt-4">
            <img
              ...
              alt="Profile"
              className="w-[166.77px] h-[166px] object-cover rounded-full"
            />
          </div>
      ...
      <div className="absolute top-[720px] flex gap-3">
        <a
          href="#artworks"
          className="w-[228px] h-[48px] px-[61px] py-[12px] bg-[#02272F] flex justify-between border border-orange-600 text-white rounded-tl-[6px] hover:bg-orange-600 hover:text-white"
        >
          <img
