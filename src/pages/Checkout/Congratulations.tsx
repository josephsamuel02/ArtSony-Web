  ...
  return (
    <div className="flex items-center justify-center mt-12 w-full mx-auto">
      <div className="flex flex-col gap-4 w-[598px] h-[744px] border border-[#F25B38] rounded-[10px] items-center mx-auto">
        ...
        <p className="w-[413px] h-[28px]">
          Confirmation email has been,
          <a href="#email" className="text-[#F25B38]">
            kenzi.lawson@example.com
          </a>
          , you can view order info and monitor progress in{" "}
          <a href="#order" className="text-[#F25B38]">
            Orders.
          </a>
        </p>
        ...
        <a
          href="#email"
          className="text-white text-center pt-6 bg-[#F25B38] w-[500px] h-[72px]  mt-6 hover:bg-orange-800"
        >
          Back to Cart
        </a>
      </div>
