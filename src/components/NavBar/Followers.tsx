...
interface compState {
  setShowFollowers: (item: boolean) => void;
}
const Followers = ({ setShowFollowers }: compState) => {
  const Artwork = [
    {
  ...
  return (
    <div className="mx-auto fixed top-20 left-0 right-0  w-11/12 h-[595px] rounded-md bg-white z-30">
      <div className="w-full h-auto px-10 pt-5 pb-2 flex flex-row items-center border-b-2 border-[#fcc1b469]">
        <h3 className="text-[24px] text-[#000000b2] font-Poppins">
          Followers <span className="text-[#F25B38B2]">(1275)</span>
        </h3>
